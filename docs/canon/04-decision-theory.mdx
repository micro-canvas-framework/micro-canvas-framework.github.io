...
A decision threshold is a canonical boundary defined by evidence sufficiency and quality; see [Definitions](./definitions) (Steele, 2015). Decisions require evidence that meets the applicable sufficiency thresholds as defined in [Evidence Logic](./evidence-logic).
