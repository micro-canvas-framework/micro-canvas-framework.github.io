...
Assessing innovation maturity is about making evidence visible, not assigning a
...
false confidence and protects optionality before commitments become harder to
reverse.
...
Assessment failures usually stem from treating it as evaluation rather than
evidence visibility:
...
Use `/docs/book/failure-modes` to interpret whether the issue is epistemic,
...
- Treating evidence absence as a minor gap instead of a decision constraint.
