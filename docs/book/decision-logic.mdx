...
```mermaid
%%{init: {"theme":"base","flowchart":{"nodeSpacing":70,"rankSpacing":90},"themeVariables":{"fontSize":"28px"}} }%%
flowchart TB

  E["**Evidence quality**<br/>Signal / strength / relevance"]
  O["**Optionality preserved**<br/>Hold reversible paths"]
  D{"**Decision threshold met?**"}
  R["**Reversible decision**<br/>Low threshold"]
  I["**Irreversible decision**<br/>High threshold"]
  RG["**Regression**<br/>Evidence weakens"]
