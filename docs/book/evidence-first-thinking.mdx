...
:::note Purpose
Clarify how evidence quality, not activity or opinion, drives progression and
decisions in MCF 2.2.
:::

:::info What this explains
- Why evidence is required to move between epistemic stages.
...
avoid "progress theater" where work looks busy but does not improve confidence.

Evidence in MCF 2.2 is not a binary yes/no. It has quality, relevance, and
limits. Good evidence clarifies which assumptions have been strengthened,
which remain weak, and which have been falsified. Evidence-first thinking
therefore asks: what would change our decision, and do we have that?
...
reverse when evidence weakens the original claim. The Book layer explains how
to apply these thresholds in context; the Canon defines them.
...
- Can you state which assumption is being tested?
- Can you explain what would falsify it?
- Can you show why the evidence is relevant and not merely available?
- Can you explain why the decision threshold is met?
