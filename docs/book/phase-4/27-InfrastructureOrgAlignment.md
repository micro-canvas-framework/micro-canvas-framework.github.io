...
## 1. Alignment as a scaling requirement
Infrastructure and organization design are not “support” functions at scale.
They determine whether decisions can be executed reliably. Misalignment
introduces variance that weakens evidence and increases risk.

## 2. What alignment looks like (explanatory)
Alignment is visible when:
- systems can absorb growth without degradation
- roles and ownership match the decision cadence
- dependencies are tracked and governed

If these conditions are missing, scaling increases noise and reduces decision
integrity.

## 3. Evidence signals for alignment
Evidence that alignment is sufficient may include:
